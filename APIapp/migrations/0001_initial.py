    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity', models.CharField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)])),
                ('age', models.IntegerField(validators=[django.core.validators.MinValueValidator(18, message='Must be 18 or older.'), django.core.validators.MaxValueValidator(100, message='Must be 100 or younger.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercises', models.ManyToManyField(to='APIapp.exercises')),
